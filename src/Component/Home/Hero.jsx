...
const Hero = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between gap-8 px-4">
      ...
      >
        <p className="text-primary text-lg font-semibold -mb-3">Hello! I am,</p>
        <motion.h1
        ...
        <h2 className="text-base md:text-2xl font-medium text-base-content/80">
          <Typewriter
            words={[
              ...
              "Paassionate Full Stack Developer",
              "Tech Enthusiast",
              "Learning TypeScript",
            ]}
            loop={100}
        ...
        >
          ...
          accessibility, and great user experience. Let's create something
          amazing together!
        </motion.p>
        {/* Social Row*/}
        <motion.div
