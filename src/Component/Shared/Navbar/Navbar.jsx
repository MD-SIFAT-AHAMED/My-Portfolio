...
const Navbar = () => {
  ...
  const linkClass =
    "hover:text-primary transition-all duration-300 hover:shadow-xl hover:shadow-primary/60 flex items-center gap-2 rounded-md btn btn-outline bg-transparent border-none hover:bg-primary hover:text-white hover:btn-primary hover:scale-110 hover:shadow-lg";
  ...
  return (
    <nav className="backdrop-blur-xl bg-gradient-to-t from-primary/2 via-base-100/50 to-primary/8 fixed top-0 left-0 w-full z-50 border-b border-dashed border-primary/30 ">
      ...
      {/* Mobile menu */}
      <div
        className={`lg:hidden backdrop-blur-xl bg-gradient-to-t from-primary/2 via-base-100/50 to-primary/8 border-b border-dashed border-primary/30 text-base-content fixed top-0 left-0 h-full w-full z-50 transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="p-6 space-y-3 backdrop-blur-xl bg-base-100 h-auto border-b border-dashed border-primary/30">
          ...
          {/* Logo */}
          <div className="w-12 h-12" onClick={handleLinkClick}>
            {/* <Logo /> */}
          </div>
